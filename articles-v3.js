...
function init(){createOverview();enrichCards();new MutationObserver(enrichCards).observe(articleList,{childList:true});new MutationObserver(enhanceReader).observe(reader,{childList:true,subtree:true});enhanceReader();const mediaScript=document.createElement('script');mediaScript.src='article-media-v4.js?v=6';mediaScript.async=false;document.head.appendChild(mediaScript)}
init();
})();
