...
(function(){
  ...
  add({
    ...
    content:[
      ...
      {type:'gallery'}
    ],migrationStatus:'source_verified_against_preserved_archive',photoCredits:['Cliparts','Dinamite SoftWare Group, 2003'],sourceMediaInventory:'data/legacy-media.json'
  });
  ...
  add({
    ...
    ],migrationStatus:'source_verified_against_preserved_archive',sourceNotes:['Географический атлас Калининградской области, 2002','материалы Google, указанные на legacy-странице']
  });
  ...
  add({
    ...
    ],migrationStatus:'source_verified_against_preserved_archive',photoCredits:['Э. Барсуков','А. Соколов']
  });
...
(function(){
  ...
  add({
    ...
    migrationStatus:'source_verified_against_preserved_archive',photoCredits:['Татьяна Поломодова','Айтель Ланге (историческое фото на исходной странице)'],
